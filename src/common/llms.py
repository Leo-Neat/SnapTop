...
def get_gemini_flash(system_prompt=None, project="recipellm"):
    return ChatVertexAI(
        model_name="gemini-2.5-flash", project=project, system_message=system_prompt
    )


def get_gemini_pro(system_prompt=None, project="recipellm"):
    return ChatVertexAI(
        model_name="gemini-2.5-pro", project=project, system_message=system_prompt
    )


def get_gemini_flash_lite(system_prompt=None, project="recipellm"):
    return ChatVertexAI(
